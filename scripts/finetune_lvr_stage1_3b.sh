...
MAX_PACKED_TOKENS=$((MAX_INSTANCE_PER_BATCH * LST))   # 8192 tokens; ZeRO-3 offload frees GPU memory
...
NUM_DEVICES=8
GRAD_ACCUM_STEPS=4            # halved from 8 → faster optimizer steps, doubled MAX_STEPS to compensate
...
RUN_NAME="Stage1_3B_${LVR_LOSS_FCT}LVRLossLambda${LAMBDA_LVR}-MaxVisToken${MAX_TOKEN}-MinVisToken${MIN_TOKEN}"
ONLINE=False
OUTPUT_DIR="checkpoints_rerun/stage1_3b/"
