...
STAGE1_STEPS=2500
CHKPT_PATH="checkpoints_rerun/stage1_3b/Qwen2.5-VL-3B-Instruct/Stage1_3B_mseLVRLossLambda0.1-MaxVisToken5120-MinVisToken128/checkpoint-${STAGE1_STEPS}/"

# data configs
DATA_PATH="/dockerx/groups/bangzheng/data/virl39k.json"
IMAGE_FOLDER="/dockerx/groups/bangzheng/images/"
OUTPUT_DIR="checkpoints_rerun/stage2_3b/"
